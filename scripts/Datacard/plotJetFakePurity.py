    ...
    for category in file.GetListOfKeys():
        ...
        for p in plots:
            ...
            if plot and overlay: 
                ...
                pl.plotJetFakes(histos, canvas="linear", signal = [], descriptions = {"plottype": "ProjectWork", "xaxis":var.tex, "channel":channel,"CoM": "13", "lumi":lumi  }, outfile = outdir +"/"+ cat+"_"+var.name + p[0] +".png", era=era, overlay=textlines )
            elif plot:
                pl.plotJetFakes(histos, canvas="linear", signal = [], descriptions = {"plottype": "ProjectWork", "xaxis":var.tex, "channel":channel,"CoM": "13", "lumi":lumi  }, outfile = outdir +"/"+ cat+"_"+var.name + p[0] +".png", era=era)
    file.Close() 
